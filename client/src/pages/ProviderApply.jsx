...
export default function ProviderApply() {
  ...
  if (done) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center space-y-3">
        ...
        <p className="text-slate-500 text-sm">We'll review it and get back to you.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-10">
      <h1 className="text-2xl font-bold text-slate-800 mb-1">Become a support provider</h1>
      <p className="text-slate-500 text-sm mb-6">For counselors, chaplains, pastors, imams, and peer-recovery coaches.</p>
      ...
      <form onSubmit={submit} className="space-y-4">
        <div>
          ...
          />
          <p className="text-xs text-slate-400 mt-1">Shown publicly — doesn't have to be your full legal name.</p>
        </div>
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-1">Credentials (optional)</label>
          <input
            value={credentials}
            ...
            className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"
          />
          <p className="text-xs text-slate-400 mt-1">Only visible to our review team, not shown publicly.</p>
        </div>
