...
export default function AdminLogin({ onLoggedIn }) {
  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-24">
      <h1 className="text-2xl font-bold text-ink mb-1">ClearDay Admin</h1>
      <p className="text-muted text-sm mb-8">Owner-only. Enter your admin secret to continue.</p>
      <form onSubmit={submit} className="space-y-4">
        <input
          ...
          className="w-full rounded-lg border border-subtle px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-slate-500"
        />
