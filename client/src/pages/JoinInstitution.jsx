...
export default function JoinInstitution() {
  ...
  if (done) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center space-y-3">
        ...
        <h1 className="text-xl font-bold text-slate-800">You've joined {done}</h1>
        <p className="text-slate-500 text-sm">Your progress now contributes to their aggregated, anonymized stats.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <h1 className="text-2xl font-bold text-slate-800 mb-1">Join an institution</h1>
      ...
      <form onSubmit={submit} className="space-y-4">
        <input
          ...
          className="w-full rounded-lg border border-slate-200 px-3 py-2.5 tracking-widest text-center text-lg"
        />
